# InfrastructureIntent Engine Glossary

> Status: Working Draft

This glossary defines the current canonical terminology for the InfrastructureIntent Engine architecture exploration.
