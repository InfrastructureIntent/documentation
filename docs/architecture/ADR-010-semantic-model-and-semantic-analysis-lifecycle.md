...
After reference resolution, Integration semantics determine what relationships mean, which resolved references imply relationships, whether relationships imply dependencies, dependency-only prerequisites where justified, dependency direction, domain provenance/explanation, and domain-specific semantic-cycle restrictions where applicable.
